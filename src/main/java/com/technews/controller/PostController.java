...
public class PostController {
    ...
    public List<Post> getAllPosts() {
        ...
        for (Post p : postList) {
            p.setVoteCount(
                    voteRepository.countVotesByPostId(p.getId())
            );
        }
        return postList;
    }
    ...
    public Post getPost(@PathVariable Integer id) {
        ...
        returnPost.setVoteCount(
                voteRepository.countVotesByPostId(returnPost.getId())
        );
        return returnPost;
    }
    ...
    public String addVote(
        ...
        if (request.getSession(false) != null) {
            ...
            returnPost.setVoteCount(
                    voteRepository.countVotesByPostId(vote.getPostId())
            );
        } else {
            returnValue = "login";
        }
